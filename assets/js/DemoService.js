    ...
    async generate() {
        ...
        for (let i = 0; i < numClients; i++) {
            ...
            const client = {
                ...
                cpfCnpj: this.getRandomInt(10000000000, 99999999999).toString(),
                rg: this.getRandomInt(10000000, 99999999).toString(),
                street: `${this.getRandomItem(this.streets)}, ${this.getRandomInt(10, 2000)}`,
