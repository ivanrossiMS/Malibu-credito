<div class="space-y-10 fade-in">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <button id="new-loan-btn" class="bg-gradient-premium hover:shadow-premium text-white px-8 py-4 rounded-[1.5rem] shadow-xl shadow-primary/20 transition-all font-black flex items-center gap-3 hover:-translate-y-1 active:scale-95">
