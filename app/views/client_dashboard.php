...
<div class="space-y-10 fade-in">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
        ...
        <div class="lg:col-span-1 space-y-8">
            ...
            <div class="premium-card p-8 bg-gradient-sidebar border-white/5 relative overflow-hidden group shadow-2xl">
                <div class="relative z-10">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <span class="text-[10px] font-black uppercase tracking-widest text-slate-400">Score Malibu</span>
                    </div>
                    <h2 id="insight-title" class="text-xl font-black mb-2 text-white font-heading">Tudo em dia! ✨</h2>
                    <p id="insight-message" class="text-slate-400 text-sm leading-relaxed font-medium">Seu comprometimento financeiro está excelente. Continue assim para desbloquear novos limites em breve.</p>
                </div>
                <i data-lucide="award" class="absolute -right-6 -bottom-6 w-32 h-32 text-white/5 -rotate-12 group-hover:rotate-0 transition-all duration-1000"></i>
            </div>
        </div>
    </div>
</div>
