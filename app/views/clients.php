            ...
            <form id="client-form" class="flex-1 overflow-y-auto custom-scrollbar p-6 sm:p-8 space-y-8">
                ...
                <div class="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-1">
                            <label class="block text-[10px] font-black text-slate-400 uppercase mb-1">RG / Órgão</label>
                            <div class="relative">
                                <i data-lucide="credit-card" class="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400"></i>
                                <input type="text" id="rg" required class="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all text-sm font-bold text-slate-700">
                            </div>
                        </div>
